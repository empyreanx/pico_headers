...
/*
    ...
    Cmdline:
        sokol-shdc --input example.glsl --output example_shader.h --format=sokol_impl --slang glsl410:hlsl5:metal_macos:metal_ios:metal_sim:glsl300es --reflection --ifdef
...
#endif
#endif
const sg_shader_desc* example_shader_desc(sg_backend backend);
int example_attr_slot(const char* attr_name);
int example_image_slot(sg_shader_stage stage, const char* img_name);
int example_sampler_slot(sg_shader_stage stage, const char* smp_name);
int example_uniformblock_slot(sg_shader_stage stage, const char* ub_name);
size_t example_uniformblock_size(sg_shader_stage stage, const char* ub_name);
int example_storagebuffer_slot(sg_shader_stage stage, const char* sbuf_name);
int example_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name);
sg_shader_uniform_desc example_uniform_desc(sg_shader_stage stage, const char* ub_name, const char* u_name);
