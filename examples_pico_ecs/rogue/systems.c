...
{
    // Player turn system
    PLAYER_SYS = ecs_define_system(game->ecs, player_sys, &(ecs_sys_def_t){ .udata = game });
    ...
    // Monster's turns
    MONSTER_SYS = ecs_define_system(game->ecs, monster_sys, &(ecs_sys_def_t){ .udata = game });
    ...
    // Chest system
    CHEST_SYS = ecs_define_system(game->ecs, chest_sys, &(ecs_sys_def_t){ .udata = game });
    ...
    // Drawable system
    DRAWABLE_SYS = ecs_define_system(game->ecs, draw_sys, &(ecs_sys_def_t){ .udata = game });
