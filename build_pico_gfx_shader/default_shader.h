...
/*
    cbuffer pg_vs_block : register(b0)
    {
        ...
        row_major float4x4 _21_u_tr : packoffset(c4);
    };
    ...
    void vert_main()
    {
        gl_Position = mul(float4(a_pos, 1.0f), mul(_21_u_tr, _21_u_proj));
        color = a_color;
        uv = a_uv;
    }
...
static const char vs_source_hlsl5[989] = {
    ...
    0x5f,0x32,0x31,0x5f,0x75,0x5f,0x74,0x72,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,
    ...
    0x31,0x5f,0x75,0x5f,0x74,0x72,0x2c,0x20,0x5f,0x32,0x31,0x5f,0x75,0x5f,0x70,0x72,
...
/*
    ...
    {
        main0_out out = {};
        out.gl_Position = (_21.u_proj * _21.u_tr) * float4(in.a_pos, 1.0);
...
static const char vs_source_metal_macos[647] = {
    ...
    0x31,0x2e,0x75,0x5f,0x74,0x72,0x29,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,
