...
#pragma pack(push,1)
PICO_GFX_ALIGN(16) typedef struct vs_block_t {
    pg_mat4_t u_proj;
    pg_mat4_t u_tr;
} vs_block_t;
#pragma pack(pop)
...
static int pg_default_sampler_slot(sg_shader_stage stage, const char* smp_name);
...
//static int pg_default_storagebuffer_slot(sg_shader_stage stage, const char* sbuf_name);
...
pg_ctx_t* pg_create_context(int window_width, int window_height, void* mem_ctx)
{
    ...
    pg_init_uniform_block(ctx->default_shader, PG_VS_STAGE, "vs_block");
