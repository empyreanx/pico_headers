/*
    ...
    Cmdline:
        sokol-shdc --input pico_gfx.glsl --output pico_gfx_shader.h --format=sokol_impl --slang glsl410:hlsl5:metal_macos:metal_ios:metal_sim:glsl300es --reflection --ifdef
...
#error "Please include sokol_gfx.h before pico_gfx_shader.h"
#endif
...
#endif
#endif
#ifndef PICO_GFX_SHADER_H
#define PICO_GFX_SHADER_H
...
int pg_default_sampler_slot(sg_shader_stage stage, const char* smp_name);
...
int pg_default_storagebuffer_slot(sg_shader_stage stage, const char* sbuf_name);
...
/*
    ...
    void main()
    {
        gl_Position = (mat4(vs_block[0], vs_block[1], vs_block[2], vs_block[3]) * mat4(vs_block[4], vs_block[5], vs_block[6], vs_block[7])) * vec4(a_pos, 1.0);
        color = a_color;
        uv = a_uv;
...
static const uint8_t vs_source_glsl410[467] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x76,0x73,0x5f,0x62,0x6c,
    0x6f,0x63,0x6b,0x5b,0x38,0x5d,0x3b,0x0a,0x6c,0x61,0x79,0x6f,0x75,0x74,0x28,0x6c,
    ...
    0x74,0x34,0x28,0x76,0x73,0x5f,0x62,0x6c,0x6f,0x63,0x6b,0x5b,0x30,0x5d,0x2c,0x20,
    0x76,0x73,0x5f,0x62,0x6c,0x6f,0x63,0x6b,0x5b,0x31,0x5d,0x2c,0x20,0x76,0x73,0x5f,
    0x62,0x6c,0x6f,0x63,0x6b,0x5b,0x32,0x5d,0x2c,0x20,0x76,0x73,0x5f,0x62,0x6c,0x6f,
    0x63,0x6b,0x5b,0x33,0x5d,0x29,0x20,0x2a,0x20,0x6d,0x61,0x74,0x34,0x28,0x76,0x73,
    0x5f,0x62,0x6c,0x6f,0x63,0x6b,0x5b,0x34,0x5d,0x2c,0x20,0x76,0x73,0x5f,0x62,0x6c,
    0x6f,0x63,0x6b,0x5b,0x35,0x5d,0x2c,0x20,0x76,0x73,0x5f,0x62,0x6c,0x6f,0x63,0x6b,
    0x5b,0x36,0x5d,0x2c,0x20,0x76,0x73,0x5f,0x62,0x6c,0x6f,0x63,0x6b,0x5b,0x37,0x5d,
    ...
    0x75,0x76,0x20,0x3d,0x20,0x61,0x5f,0x75,0x76,0x3b,0x0a,0x20,0x20,0x20,0x20,0x67,
...
static const uint8_t vs_source_glsl300es[428] = {
    ...
    ,
...
/*
    ...
    {
        row_major float4x4 _19_u_proj : packoffset(c0);
        row_major float4x4 _19_u_tr : packoffset(c4);
    };
    ...
    void vert_main()
    {
        gl_Position = mul(float4(a_pos, 1.0f), mul(_19_u_tr, _19_u_proj));
        color = a_color;
        uv = a_uv;
    }
...
static const uint8_t vs_source_hlsl5[986] = {
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x5f,0x31,0x39,0x5f,0x75,0x5f,0x70,
    ...
    0x5f,0x75,0x5f,0x74,0x72,0x20,0x3a,0x20,0x70,0x61,0x63,0x6b,0x6f,0x66,0x66,0x73,
    ...
    0x31,0x2e,0x30,0x66,0x29,0x2c,0x20,0x6d,0x75,0x6c,0x28,0x5f,0x31,0x39,0x5f,0x75,
    0x5f,0x74,0x72,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x75,0x5f,0x70,0x72,0x6f,0x6a,0x29,
...
/*
    ...
    {
        main0_out out = {};
        out.gl_Position = (_19.u_proj * _19.u_tr) * float4(in.a_pos, 1.0);
...
static const uint8_t vs_source_metal_macos[641] = {
    ...
    0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x75,0x5f,0x70,0x72,0x6f,0x6a,0x3b,0x0a,0x20,
    0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x78,0x34,0x20,0x75,0x5f,0x74,0x72,
    ...
    0x61,0x5f,0x70,0x6f,0x73,0x20,0x5b,0x5b,0x61,0x74,0x74,0x72,0x69,0x62,0x75,0x74,
    0x65,0x28,0x30,0x29,0x5d,0x5d,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,
    0x74,0x34,0x20,0x61,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x5b,0x5b,0x61,0x74,0x74,
    ...
    0x62,0x6c,0x6f,0x63,0x6b,0x26,0x20,0x5f,0x31,0x39,0x20,0x5b,0x5b,0x62,0x75,0x66,
    ...
    0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x28,0x5f,0x31,0x39,0x2e,0x75,
    0x5f,0x70,0x72,0x6f,0x6a,0x20,0x2a,0x20,0x5f,0x31,0x39,0x2e,0x75,0x5f,0x74,0x72,
    0x29,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x69,0x6e,0x2e,0x61,0x5f,
    0x70,0x6f,0x73,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,
    0x75,0x74,0x2e,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x69,0x6e,0x2e,0x61,0x5f,
...
*/
#if defined(SOKOL_METAL)
static const uint8_t vs_source_metal_ios[641] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
#if defined(SOKOL_METAL)
static const uint8_t vs_source_metal_sim[641] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
